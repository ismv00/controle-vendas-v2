...
const inputClass =
  'w-full rounded-input border border-border-input bg-surface-subtle-2 py-2.5 pl-10 pr-10 text-[13px] text-ink placeholder:text-placeholder focus:outline-none focus:border-accent';
...
export default function RegisterPage() {
  ...
  async function handleGoogleSignup() {
    ...
    try {
      ...
      if (code !== 'auth/popup-closed-by-user' && code !== 'auth/cancelled-popup-request') {
        setError('Não foi possível criar a conta com o Google. Tente novamente.');
      }
    } finally {
  ...
  return (
    <AuthLayout>
      ...
      <h1 className="text-[22px] font-bold tracking-[-.02em] text-ink">Criar conta</h1>
      <p className="mt-1 text-[13px] text-ink-3">Preencha os dados para começar a usar o sistema.</p>
